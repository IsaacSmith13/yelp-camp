...
// Reviews New
router.get("/new", ensureLoggedIn('/login'), middleware.checkReviewExistence, function(req, res) {
...
// Reviews Create
router.post("/", ensureLoggedIn('/login'), middleware.checkReviewExistence, function(req, res) {
...
// Reviews Edit
router.get("/:review_id/edit", ensureLoggedIn('/login'), middleware.isReviewOwner, function(req, res) {
...
// Reviews Update
router.put("/:review_id", ensureLoggedIn('/login'), middleware.isReviewOwner, function(req, res) {
...
// Reviews Delete
router.delete("/:review_id", ensureLoggedIn('/login'), middleware.isReviewOwner, function(req, res) {
